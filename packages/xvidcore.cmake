ExternalProject_Add(xvidcore
    ...
    CONFIGURE_COMMAND ${EXEC} cd <SOURCE_DIR>/build/generic && CFLAGS='-std=gnu17' CONF=1 ./configure # running configure outside that directory will make it happily ignore --host while building
        --host=${TARGET_ARCH}
